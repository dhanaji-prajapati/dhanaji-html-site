  ...
  build: {
    rollupOptions: {
      input: {
        ...
        blogArticle1: resolve(__dirname, 'blog/how-to-fix-crawlability-and-indexing-issues/index.html'),
        blogArticle2: resolve(__dirname, 'blog/traditional-seo-vs-ai-search-visibility/index.html'),
        blogArticle3: resolve(__dirname, 'blog/looker-studio-seo-reporting-guide/index.html'),
